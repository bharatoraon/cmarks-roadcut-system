...
// Ideally from env
const MAPBOX_TOKEN = "pk.eyJ1IjoiYmhhcmF0b3Jhb24iLCJhIjoiY21nd2l3eDNpMGl6cTJrc2lpa2I1czgybyJ9.K_ICeJ0NzQi4bPLGgmF9Yw";

export default function MapView({ onSelectRoad, theme, flyToLocation, layers, clickedLocation }) {
    ...
    useEffect(() => {
        ...
        const styleUrl = theme === 'dark' ? 'mapbox://styles/mapbox/dark-v11' : 'mapbox://styles/mapbox/light-v11';
